          ...
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 relative z-20">
              <Button 
                asChild 
                size="lg" 
                className="bg-[#FF6B35] hover:bg-[#E55A2B] text-white text-lg px-8 py-6 h-auto shadow-lg hover:shadow-xl transition-all relative z-10"
              >
              ...
              <Button 
                ...
                size="lg" 
                variant="outline"
                className="text-lg px-8 py-6 h-auto border-2 border-[#2C2C2C] hover:bg-[#2C2C2C] hover:text-white transition-all relative z-10"
              >
